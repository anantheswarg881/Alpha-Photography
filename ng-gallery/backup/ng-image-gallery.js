								...
								'<div class="ng-image-gallery-content" ng-show="!imgLoading" ng-click="backgroundClose($event);">'+
									...
									'<div class="galleria">'+
										...
										'<div class="galleria-images img-anim-{{imgAnim}} img-move-dir-{{imgMoveDirection}}">' +
											'<div ng-click="methods.close();" style="width: 100%; height: 100%; postion: relative;" ></div> <img class="galleria-image" ng-repeat="image in images track by $index" ng-if="activeImg == image" ng-src="{{image.url}}" ondragstart="return false;" oncontextmenu="return false;" ng-attr-title="{{image.title || undefined}}" ng-attr-alt="{{image.alt || undefined}}"/>' +
										'</div>'+
										...
										'<div id="thumbnailsdiv" class="galleria-bubbles" ng-if="bubbles && imgBubbles" ng-hide="images.length == 1">'+
