module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            dist: {
                files: {
                    'js/main.js': ['js/angular1.5.js', 'js/angular-route1.5.js', 'js/angular-animate1.5.js', 'js/angular-touch.min.js', 'js/haamer.min.js', 'ng-gallery/ng-image-gallery.js',
                    //'js/main.js': ['js/angular.min.js', 'js/angular-animate.js', 'js/angular-touch.min.js', 'js/haamer.min.js', 'ng-gallery/ng-image-gallery.js',
                                    ...
                                    'js/count-to.js', 'js/jquery.nicescroll.min.js', 'js/jquery-1.10.2.min.js', 
